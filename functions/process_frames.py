...
def process_video(message):
    ...
    for face in faces:
        ...
        global LIP_DISTANCE_THRESHOLD
        global determining_lip_distance
        ...
        if(determining_lip_distance != 0 and LIP_DISTANCE_THRESHOLD != None):
            ...
            # global LIP_DISTANCE_THRESHOLD
            threshhold = LIP_DISTANCE_THRESHOLD
            if lip_distance > threshhold: # person is talking
                print("Talking")
            ...
            #we are calibrating the not-talking distance
            print("KEEP MOUTH CLOSED, CALIBRATING DISTANCE BETWEEN LIPS")
            ...
            if(determining_lip_distance == 0):
                global LIP_DISTANCE_THRESHOLD
                LIP_DISTANCE_THRESHOLD = sum(lip_distances) / len(lip_distances) + 4
